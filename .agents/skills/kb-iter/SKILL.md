---
name: kb-iter
description: Knowledge-base iteration analysis — scan the whole vault, find coverage gaps, unprocessed content, isolated entries, broken links and hallucinations, and output an iteration report with recommendations. Triggers on "/kb-iter", "knowledge base iteration", "health check" or "analyze the knowledge base".
---

> This skill is part of the Kei-Second-Brain ecosystem. System overview is in `README.md`.

# kb-iter — Knowledge-Base Iteration Analysis

## Trigger

User says "/kb-iter", "knowledge base iteration", "analyze the knowledge base", "health check", or similar.
...
Write `3_KnowledgeBaseIterationLog/YYYY-MM-DD-iteration-report.md`.
